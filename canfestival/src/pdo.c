...
proceedPDO (CO_Data * d, Message * m)
{
  ...
  status = state2;
	MSG_PRI(0x3935,"proceedPDO, cobID : ", (UNS16_LE(m->cob_id) & 0x7ff));
                ...
                if (*pwCobId == UNS16_LE(m->cob_id))
                  {
                    ...
                    MSG_WAR (0x3936, "cobId found at index ",
                             0x1400 + numPdo);
                    MSG_PRI (0x3936, "cobId found at index ",
                             0x1400 + numPdo);										
                    break;
                  }
                else
                    ...
                    if (pMappingParameter == NULL)
                      {
                        MSG_ERR (0x1937, "Couldn't get mapping parameter : ",
                                 numMap + 1);
                        MSG_PRI (0x1937, "Couldn't get mapping parameter : ",
                                 numMap + 1);
                        return 0xFF;
                      }
                    ...
                    if (Size && ((offset + Size) <= (m->len << 3)))
                      {
                        ...
                        if (objDict != OD_SUCCESSFUL)
                          {
                            ...
                            MSG_WAR (0x2940, "                subindex : ",
                                     ...
                                     "error accessing to the mapped var : ",
                                     numMap + 1);
                            MSG_PRI (0x2939, "         Mapped at index : ",
                                     (*pMappingParameter) >> 16);
                            MSG_PRI (0x2940, "                subindex : ",
                                     ((*pMappingParameter) >> 8) & 0xFF);
                            return 0xFF;
                          }
                        ...
                        MSG_WAR (0x3944, "                subindex : ",
		                        ...
		                        MSG_PRI (0x3942,
                                 "Variable updated by PDO cobid : ",
                                 UNS16_LE(m->cob_id));
                        MSG_PRI (0x3943, "         Mapped at index : ",
                                 (*pMappingParameter) >> 16);
                        MSG_PRI (0x3944, "                subindex : ",
                                 ((*pMappingParameter) >> 8) & 0xFF);											
